...
import com.happiest.game.base.action.*
    ...
    open class Builder<B : Builder<B>> constructor(private val context: Context) :
        ...
        open fun create(): BaseDialog {
            ...
            dialog!!.let { it ->
                ...
                it.setOnShowListeners(showListeners)
                it.setOnCancelListeners(cancelListeners)
                it.setOnDismissListeners(dismissListeners)
