...
object deps {
    ...
    object versions {
        ...
        const val libretrodroid   = "62487b63"
        const val radialgamepad   = "73106e82"
        const val qmui            = "2.0.0-alpha10"
        const val qmui_arch_version = "2.0.0-alpha10"
        const val titleBar        = "9.2"
        const val kotlinJdk7      = "1.5.21"
    }
    ...
    object libs {
        ...
        object arch {
            ...
            object qmui {
                const val qmuiArch = "com.qmuiteam:arch:${versions.qmui_arch_version}"
                const val qmuiArchCompiler = "com.qmuiteam:arch-compiler:${versions.qmui_arch_version}"
            }
        }
        object autodispose {
        ...
        object kotlin {
            ...
            const val stdlibJdk7 = "org.jetbrains.kotlin:kotlin-stdlib-jdk7:${versions.kotlinJdk7}"
        }
        object epoxy {
        ...
        const val txqmui                   = "com.qmuiteam:qmui:${versions.qmui}"
        const val myTile                   = "com.github.getActivity:TitleBar:${versions.titleBar}"
        const val immersionbar             = "com.gyf.immersionbar:immersionbar:3.0.0"
        const val xxPermission             = "com.github.getActivity:XXPermissions:16.0"
        const val aspectjrt                = "org.aspectj:aspectjrt:1.9.6"
        //https://github.com/getActivity/EasyHttp
        const val easyHttp                 = "com.github.getActivity:EasyHttp:11.2"
        ...
        const val mmkv                     = "com.tencent:mmkv-static:1.2.12"
    ...
    object share {
        ...
        const val common = "com.umeng.umsdk:common:9.5.2"// (必选)
        const val asms = "com.umeng.umsdk:asms:1.6.3"// 必选

        //友盟Push依赖
        const val push = "com.umeng.umsdk:push:6.5.4"
        const val shareCore = "com.umeng.umsdk:share-core:7.2.0" //分享核心库，必选
        const val shareBoard = "com.umeng.umsdk:share-board:7.2.0" //分享面板功能，可选

        //在线依赖目前支持QQ、微信、新浪微博、支付宝、钉钉；若需支持其他平台，请选择手动下载SDK
        const val shareWx = "com.umeng.umsdk:share-wx:7.1.9" //微信完整版
        const val androidWithoutMta = "com.tencent.mm.opensdk:wechat-sdk-android-without-mta:6.7.9" //微信官方依赖库，必选

        const val shareQq ="com.umeng.umsdk:share-qq:7.1.9" //QQ完整版
        const val qqopensdk = "com.tencent.tauth:qqopensdk:3.53.0" //QQ官方依赖库，必选
        const val okhttp = "com.squareup.okhttp3:okhttp:3.12.12" //QQ SDK在3.53.0版本及以上时需要集成okhttp官方依赖库，必选
    }

    object configs {
        // 友盟 AppKey
        const val UMENG_APP_KEY = "63273e5505844627b54c782d"
        // QQ AppId
