...
import com.happiest.game.common.dump
...
import com.happiest.game.common.graphics.takeScreenshot
import com.happiest.game.common.kotlin.filterNotNullValues
import com.happiest.game.common.kotlin.toIndexedMap
import com.happiest.game.common.kotlin.zipOnKeys
import com.happiest.game.common.view.setVisibleOrGone
import com.happiest.game.lib.util.subscribeBy
import com.happy.game.core.*
import com.happy.game.core.HappyFunJni.Companion.MOTION_SOURCE_ANALOG_LEFT
import com.happy.game.core.HappyFunJni.Companion.MOTION_SOURCE_ANALOG_RIGHT
import com.happy.game.core.HappyFunJni.Companion.MOTION_SOURCE_DPAD
...
abstract class BaseGameActivity : ImmersiveActivity() {
    ...
    private val retroGameViewObservable = BehaviorRelay.createDefault<Optional<GLRetroView>>(None)
