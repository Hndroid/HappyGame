...
class UpdateDialog {
    ...
    class Builder(context: Context) : BaseDialog.Builder<Builder>(context) {
         ...
         */
        @CheckNet
        @Permissions(Permission.READ_EXTERNAL_STORAGE, Permission.WRITE_EXTERNAL_STORAGE, Permission.MANAGE_EXTERNAL_STORAGE, Permission.REQUEST_INSTALL_PACKAGES)
        private fun downloadApk() {
            ...
            val notificationBuilder: NotificationCompat.Builder = NotificationCompat.Builder(getContext(), channelId)
                ...
                // 设置通知小图标
                .setSmallIcon(R.mipmap.lemuroid_launcher)
                // 设置通知大图标
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.lemuroid_launcher))
                // 设置通知静音
...
//                }).start()
        ...
        private fun getInstallIntent(): Intent {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                uri = FileProvider.getUriForFile(getContext(), BuildConfig.APPLICATION_ID + ".provider", apkFile!!)
