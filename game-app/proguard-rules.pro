...
-keep,includedescriptorclasses class com.happiest.game.**$$serializer { *; }
-keepclassmembers class com.happiest.game.** {
    *** Companion;
}
-keepclasseswithmembers class com.happiest.game.** {
#    kotlinx.serialization.KSerializer serializer(...);
}

## LibretroDroid
-keep class com.happiest.game.** { *; }
