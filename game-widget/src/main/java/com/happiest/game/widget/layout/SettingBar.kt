package com.happiest.game.widget.layout
 ...
 *    desc   : 设置条自定义控件
 */
class SettingBar constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) :
    ...
    fun setLeftDrawable(drawable: Drawable?): SettingBar = apply {
        ...
        setLeftDraawbleTint(leftDrawableTint)
    }
     ...
     * 设置左边的图标着色器
     */
    fun setLeftDraawbleTint(color: Int): SettingBar = apply {
