...
class SlantedTextView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private fun drawBackground(canvas: Canvas) {
        ...
        when (gravity) {
            Gravity.LEFT, Gravity.LEFT or Gravity.TOP -> if (triangle) {
            ...
            Gravity.NO_GRAVITY, Gravity.RIGHT, Gravity.RIGHT or Gravity.TOP -> if (triangle) {
                path.lineTo(width.toFloat(), 0f)
            ...
            Gravity.BOTTOM, Gravity.LEFT or Gravity.BOTTOM -> if (triangle) {
                path.lineTo(width.toFloat(), height.toFloat())
                path.lineTo(0f, height.toFloat())
            } else {
                path.lineTo(width.toFloat(), height.toFloat())
            ...
            Gravity.RIGHT or Gravity.BOTTOM -> if (triangle) {
